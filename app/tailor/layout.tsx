...
import { LogOut, Menu, Home, Package, DollarSign, Star } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside
          className={`w-64 border-r bg-card transition-transform md:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
